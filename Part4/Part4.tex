...
\begin{figure}
    \begin{overprint}
    \onslide<1>\centering\fcolorbox{HHturquoise_d}{HHwhite2}{\includegraphics[width=1\textwidth]{Part1/Img/HH_XSec_as_S.png}}
    \onslide<2-3>\centering\fcolorbox{HHred}{HHwhite2}{\includegraphics[width=1\textwidth]{Part4/Img/likelihood_subplot_14TeV.pdf}}
   \end{overprint}
\end{figure}
...
\begin{itemize}
    ...
    \item European strategy (2019) expects: 
    \begin{center}
       \textit{ \textcolor{gray}{ATLAS+CMS}}
    \end{center}
    \begin{itemize}
        \item Significance of \textbf{\textcolor{HHred}{4$\sigma$}}
        \item \textbf{$\sigma_{\kappa_{\lambda}} = 50\%$ at 68\% CL}
    \end{itemize}
    \onslide<2-3>{
