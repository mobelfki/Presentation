...
\begin{figure}
    ...
    \onslide<3>\centering\fcolorbox{structurColor}{HHwhite2}{\includegraphics[width=1.\textwidth]{Part6/Img/UnConvertedllg_After_ID_Bin_1.png}}
    \onslide<4->\centering\fcolorbox{HHred}{HHwhite2}{\includegraphics[width=1.\textwidth]{Part6/Img/Tight_Inc_vs_Tight_CNN__UnConverted_Iso_tight_Wgt_ETA_Bin_1.png}}
    \end{overprint}
\end{figure}
...
\begin{figure}
    \begin{overprint}
    \onslide<2>\centering\fcolorbox{HHturquoise_d}{HHwhite2}{\includegraphics[width=1\textwidth]{Part6/Img/Eff_Tight_All_Inclusive_Tight_E_Sig.pdf}}
